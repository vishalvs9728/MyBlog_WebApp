...
<!-- banner -->
 <div class="container-fluid p-0 m-0">
            ...
            <div class="jumbotron primary-background text-white banner-background">
                <div class="container">
                    <h3 class="display-3 ">       Welcome to Python Programming </h3>
                    <img src="pics/py.png">
                    
               <br>
               <br>
          <p>According to the creator Guido Van Rossum, 
the name of this language was derived from the British comedy series 
"Monty Python's Flying Circus". The comedy was aired on BBC during the 1970s and 
it gave the creator some form of entertainment during the language development. Also,
 Van Rossum wanted a name that was short, and mysterious. Something that will capture everyone's attention.</p>
 <br>
 
 <p>This one sounds interesting right. Believe it or not, in 2015, 
 Python overtook French to be the most popular languages that are taught in primary schools. 
...
The same statistics revealed that 75% of primary school-going children preferred to learn how to control a 
robot instead of learning French.</p>
